        ...
        while 1:
            try:
                ...
                for tr in all_tr:
                    ...
                    topic_queue.put((topic_url, True))
    ...
    def run(self):
        while 1:
            try:
                ...
                if next_page:
                    next_url = parse.urljoin(main_url, next_page[0])
                    topic_queue.put((next_url, False))
            except IndexError:
                continue
